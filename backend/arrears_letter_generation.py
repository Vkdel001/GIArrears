...
try:
    df = pd.read_excel("Extracted_Arrears_Data.xlsx", engine='openpyxl')
    ...
    print("[ERROR] Excel file 'Extracted_Arrears_Data.xlsx' not found in the current directory")
    sys.exit(1)
except Exception as e:
...
try:
    df.to_excel("Extracted_Arrears_Data.xlsx", index=False, engine='openpyxl')
